                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <ul class="mt-2 space-y-2">
                                ...
                                <li><a href="/work/connection-project/#ethiopia-donation" class="text-gray-600 hover:underline" on:click={closeAllDropdowns}>Empowering Students at Medresa-Hamza School – Ethiopia</a></li>
                            </ul>
                        </div>
                        <div>
